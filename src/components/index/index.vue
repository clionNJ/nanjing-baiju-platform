<template>
  <div class="my-component">
    ...
    <div class="container">
      ...
      <div id="language-page" class="page active">
        ...
        <div class="language-grid">
          <div class="language-card" @click="selectTypesOfSongs('zh-CN')">
          ...
          <div class="language-card" @click="selectTypesOfSongs('en')">
          ...
          <div class="language-card" @click="selectTypesOfSongs('es')">
          ...
          <div class="language-card" @click="selectTypesOfSongs('fr')">
          ...
          <div class="language-card" @click="selectTypesOfSongs('ja')">
          ...
          <div class="language-card" @click="selectTypesOfSongs('ar')">
      ...
      <div id="genre-page" class="page" style="display: none;">
        ...
        <div class="button-container">
          <button class="btn back-btn" @click="goBackToLanguageFromGenre()" id="genre-back-btn">返回语言选择</button>
        </div>
      </div>
      ...
      <div id="feature-page" class="page">
        ...
        <div class="feature-grid">
          <div class="feature-card" @click="showFunctionDetail('feature1')">
          ...
          <div class="feature-card" @click="showFunctionDetail('feature2')">
          ...
          <div class="feature-card" @click="showFunctionDetail('feature5')">
          ...
          <div class="feature-card" @click="showFunctionDetail('feature6')">
        ...
        <div class="button-container">
          <button class="btn back-btn" @click="goBackToLanguage()" id="back-btn" data-simple="返回语言">返回语言选择
          </button>
          <button class="btn" id="help-btn" @click="showHelp()" data-simple="帮助">获取帮助</button>
        </div>
      </div>
      ...
      <div id="feature-page-kunqu" class="page" style="display: none;">
        ...
        <div class="button-container">
          <button class="btn back-btn" @click="goBackToLanguage()" id="back-btn-kunqu" data-simple="返回曲种">
            返回曲种选择
          </button>
          <button class="btn" @click="showHelp()" data-simple="帮助">获取帮助</button>
        </div>
      </div>
      ...
      <div id="feature-page-pintang" class="page" style="display: none;">
        ...
        <div class="button-container">
          <button class="btn back-btn" @click="goBackToLanguage()" id="back-btn-pintang" data-simple="返回曲种">
            返回曲种选择
          </button>
          <button class="btn" @click="showHelp()" data-simple="帮助">获取帮助</button>
        </div>
      ...
      <div id="feature-page-yangju" class="page" style="display: none;">
        ...
        <div class="button-container">
          <button class="btn back-btn" @click="goBackToLanguage()" id="back-btn-yangju" data-simple="返回曲种">
            返回曲种选择
          </button>
          <button class="btn" @click="showHelp()" data-simple="帮助">获取帮助</button>
        </div>
    ...
    <div id="feature1-detail" class="feature-detail">
      <button class="close-btn" @click="closeFeatureDetail('feature1')">&times;</button>
      ...
      <div class="virtual-character">
        ...
        <div class="character-controls">
          <button class="btn" id="f1-btn-play1" @click="playPerformance('song1')">
            <i class="fas fa-play"></i> 播放《秦淮灯会》
          </button>
          <button class="btn" id="f1-btn-play2" @click="playPerformance('song2')">
            <i class="fas fa-play"></i> 播放《金陵四季》
          </button>
          <button class="btn" id="f1-btn-stop" @click="stopPerformance()">
    ...
    <div id="feature2-detail" class="feature-detail">
      <button class="close-btn" @click="closeFeatureDetail('feature2')">&times;</button>
      ...
      <div class="singing-interface">
        ...
        <div style="display: flex; gap: 10px; margin: 15px 0;">
          <button class="btn" id="f2-btn-song1" style="padding: 8px 15px;" @click="selectTrainingSong('song1')">
            秦淮灯会
          </button>
          <button class="btn" id="f2-btn-song2" style="padding: 8px 15px;" @click="selectTrainingSong('song2')">
            金陵四季
          </button>
          <button class="btn" id="f2-btn-song3" style="padding: 8px 15px;" @click="selectTrainingSong('song3')">
            南京美食
          </button>
        </div>
    ...
    <div id="feature3-detail" class="feature-detail">
      <button class="close-btn" @click="closeFeatureDetail('feature3')">&times;</button>
      ...
      <div style="margin: 20px 0;">
        ...
        <div class="knowledge-grid">
          <div class="knowledge-card" @click="selectCourse('history')">
            <i class="fas fa-landmark"></i>
            <h5 id="f3-course1-title">白局历史</h5>
            <p id="f3-course1-desc">了解白局的起源与发展历程</p>
          </div>
          <div class="knowledge-card" @click="selectCourse('technique')">
            <i class="fas fa-music"></i>
            <h5 id="f3-course2-title">唱腔技巧</h5>
            <p id="f3-course2-desc">学习白局的独特唱腔与表演技巧</p>
          </div>
          <div class="knowledge-card" @click="selectCourse('instruments')">
    ...
    <div id="feature4-detail" class="feature-detail">
      <button class="close-btn" @click="closeFeatureDetail('feature4')">&times;</button>
    ...
    <div id="feature5-detail" class="feature-detail">
      <button class="close-btn" @click="closeFeatureDetail('feature5')">&times;</button>
    ...
    <div id="feature6-detail" class="feature-detail">
      <button class="close-btn" @click="closeFeatureDetail('feature6')">&times;</button>
      ...
      <div class="feedback-interface">
        <div class="feedback-form">
          ...
          <button id="f6-submit-btn" class="btn" style="width: 100%;" @click="submitFeedback()">提交反馈</button>
        </div>
...
import {initTrainingModule, originalTexts, replaceTextIds, selectTypesOfSongs, showFunctionDetail} from "./js/main.js"
